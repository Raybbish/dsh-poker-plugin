...
export class TableService {
    ...
    tableIsDeliberatelyAbandoned(state) {
        const humans = state.seats.filter((seat) => seat !== null && seat !== undefined && seat.isBot !== true);
    ...
    chipsOwnedAtCancellation(state, seat) {
    ...
    async finalizeTableDeletion(state) {
