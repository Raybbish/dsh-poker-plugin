...
function translateLog(text, locale) {
  ...
  const rules = [
    ...
    [/^(.+) left the hand \((.+)\)\.$/, (_a, name2, reason) => `${name2} \u79BB\u5F00\u672C\u624B\u724C\uFF08${reason === "left the table" ? "\u79BB\u5F00\u724C\u684C" : reason}\uFF09\u3002`],
    ...
    React11.createElement(
      ...
      tables.map((t) => {
        ...
        return React11.createElement(
          ...
          React11.createElement("span", { className: `hp-badge ${t.status === "playing" ? "live" : "wait"}` }, tx(locale, t.status === "playing" ? "playing" : "waiting")),
