...
export declare const MIN_RANK = 2;
export declare const MAX_RANK = 14;
export declare const SUIT_COUNT = 4;
export declare const DECK_SIZE = 52;
/** Stable string id of a card, e.g. "14s" for ace of spades. */
export declare function cardId(card: Card): string;
export interface CardBack {
    /** Render a facedown card: never carries rank/suit. */
    back: true;
}
export declare function isCardBack(v: unknown): v is CardBack;
