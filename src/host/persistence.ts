...
export const pokerDomainSpec = defineDomain({
  ...
  version: 1,
  tables: {
    tables: domainTable<string, z.infer<typeof tableStateSchema>>(tableStateSchema),
    ledger: domainTable<string, z.infer<typeof ledgerEntrySchema>>(ledgerEntrySchema),
    players: domainTable<string, z.infer<typeof playerRecordSchema>>(playerRecordSchema),
  },
});
